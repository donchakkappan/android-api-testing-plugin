...
/**
 * Adapter to set API Hit details to the Manual API Hits Section
 */
class ManualHitsAdapter : AbstractTableModel() {

    private val tableDataset: MutableList<APIHitDetailsModel> = Lists.newArrayList()

    companion object {
        const val COLUMN_1 = 0
        private val COLUMNS: List<String> = Lists.newArrayList("Manual Hits")
    }
    ...
    /**
     * Clear all data set from the table.
     */
    fun clear() {
        tableDataset.clear()
